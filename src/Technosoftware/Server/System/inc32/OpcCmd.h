...
typedef struct tagOpcCmdCommandDescription
    ...
    OpcCmdEventDefinition *pEventDefinitions;
    DWORD dwNoOfStateDefinitions;
    OpcCmdStateDefinition *pStateDefinitions;
    DWORD dwNoOfActionDefinitions;
    OpcCmdActionDefinition *pActionDefinitions;
    DWORD dwNoOfTransitions;
    OpcCmdStateTransition *pTransitions;
    DWORD dwNoOfInArguments;
    OpcCmdArgumentDefinition *pInArguments;
    DWORD dwNoOfOutArguments;
    OpcCmdArgumentDefinition *pOutArguments;
    DWORD dwNoOfSupportedControls;
    LPWSTR *pszSupportedControls;
    DWORD dwNoOfAndDependencies;
    LPWSTR *pszAndDependencies;
    DWORD dwNoOfOrDependencies;
    LPWSTR *pszOrDependencies;
    DWORD dwNoOfNotDependencies;
    LPWSTR *pszNotDependencies;
...
typedef struct tagOpcCmdStateChangeEvent
    ...
    LPWSTR szStateData;
    DWORD dwNoOfInArguments;
    OpcCmdArgument *pInArguments;
    DWORD dwNoOfOutArguments;
    OpcCmdArgument *pOutArguments;
